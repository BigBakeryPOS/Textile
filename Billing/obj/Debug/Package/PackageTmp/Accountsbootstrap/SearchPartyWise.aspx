<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchPartyWise.aspx.cs"
    Inherits="Billing.Accountsbootstrap.SearchPartyWise" %>
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-2">
                                <h1 class="page-header" style="text-align: center; color: #fe0002; font-size: 20px;
                                    font-weight: bold">
                                    Search PartyWise Details
                                </h1>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    Select Party
                                    <asp:DropDownList ID="ddlParty" runat="server" CssClass="chzn-select" Width="100%">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-lg-2">
                        ...
                        <div id="Excel" runat="server">
                            <div class="col-lg-12">
                                <div class="col-lg-12">
                                    <div>
                                        <b>Party Master:</b>
                                        <asp:GridView ID="gvcust" runat="server" CssClass="myGridStyle1" EmptyDataText="No records Found"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="Contact Person" DataField="ContacrPerson" />
                                                <asp:BoundField HeaderText="Mobile" DataField="MobileNo" />
                                                <asp:BoundField HeaderText="Followed By" DataField="empname" />
                                                <asp:BoundField HeaderText="State" DataField="State" />
                                                <asp:BoundField HeaderText="IsForeign" DataField="IsForeign" />
                                                <asp:BoundField HeaderText="Is Approved" DataField="status" />
                                            </Columns>
                                    ...
                                    <div>
                                        <b>Purchase Order: </b>
                                        <asp:GridView ID="GVPurchaseOrder" runat="server" CssClass="myGridStyle1" EmptyDataText="No records Found"
                                            Width="100%" AutoGenerateColumns="false">
                                            <HeaderStyle BackColor="White" />
                                            <EmptyDataRowStyle HorizontalAlign="Center" BackColor="White" ForeColor="Black" />
                                            <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast"
                                    ...
                                    <div>
                                        <b>Purchase GRN: </b>
                                        <asp:GridView ID="GVPurchaseGRN" runat="server" CssClass="myGridStyle1" EmptyDataText="No records Found"
                                            Width="100%" AutoGenerateColumns="false">
                                            <HeaderStyle BackColor="White" />
                                            <EmptyDataRowStyle HorizontalAlign="Center" BackColor="White" ForeColor="Black" />
                                            <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast"
