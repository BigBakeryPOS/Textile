<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerWiseContractorWiseBreakup.aspx.cs"
    Inherits="Billing.Accountsbootstrap.CustomerWiseContractorWiseBreakup" %>
...
<head id="Head1" runat="server">
    ...
    <title>CUSTOMER WISE CONTRACTOR WISE BREAK UP</title>
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-3">
                                <h1 class="page-header" style="text-align: center; color: #fe0002; font-size: 20px;
                                    font-weight: bold">
                                    Customer Wise Summary Production Status
                                </h1>
                            </div>
                            <div class="col-lg-2">
                        ...
                        <div id="Excel" runat="server">
                            <div class="col-lg-12">
                                <div id="div2" runat="server" style="overflow: auto; height: 500px; width: 100%">
                                    ...
                                    <br />
                                    <asp:GridView ID="gridview" runat="server" EmptyDataText="No Records Found" Caption="Customer Wise Contractor Wise Breakup"
                                        ShowHeader="false" AutoGenerateColumns="true" Width="100%" GridLines="Both">
