<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CuttingProcessEntry.aspx.cs"
    Inherits="Billing.Accountsbootstrap.CuttingProcessEntry" %>
        ...
        <div class="col-lg-12">
            <div class="col-lg-9">
                <asp:GridView ID="GVItem" AutoGenerateColumns="False" runat="server" OnRowCommand="GVItem_OnRowCommand"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ReturnQty" HeaderStyle-Width="40px" ItemStyle-Font-Size="Large"
                            ItemStyle-Font-Bold="true">
                            <ItemTemplate>
                                <asp:Label ID="lblReturnQty" Height="30px" Width="40px" runat="server" Text='<%#Eval("ReturnQty")  %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <div class="col-lg-3">
                ...
                <asp:Label ID="DamageQty" runat="server" Visible="false"></asp:Label>
                 <asp:Label ID="ReturnQty" runat="server" Visible="false"></asp:Label>
                ...
                <asp:GridView ID="GVSizes" AutoGenerateColumns="False" GridLines="Both" runat="server" ShowFooter="true" OnRowDataBound="GVSize_rowdatabound"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ReturnQty" HeaderStyle-Width="50px" ItemStyle-Font-Size="Large"
                            ItemStyle-Font-Bold="true">
                            <ItemTemplate>
                                <asp:TextBox ID="txtReturnQty" AutoComplete="off" Height="30px" Width="100%" runat="server" OnTextChanged="Damage_changed" AutoPostBack="true" Text='<%#Eval("ReturnQty")%>'></asp:TextBox>
                                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender312522" runat="server"
                                    TargetControlID="txtReturnQty" FilterType="Numbers" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
                <asp:GridView ID="GVSizesView" AutoGenerateColumns="False" GridLines="Both" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="ReturnQty" HeaderStyle-Width="100px" ItemStyle-Font-Size="Large"
                            ItemStyle-Font-Bold="true">
                            <ItemTemplate>
                                <asp:Label ID="lblReturnQty" Height="30px" runat="server" Text='<%#Eval("ReturnQty")%>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
