                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <label>
                                                        Reed/Pick:</label>
                                                    <asp:TextBox ID="txtreedpick" OnTextChanged="Reed_Pick" AutoPostBack="true" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    <label>
                                                        Quality :</label>
                                                    <asp:TextBox ID="txtquality" OnTextChanged="Quality_Chnaged" AutoPostBack="true" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
