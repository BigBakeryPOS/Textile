<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SamplingCosting_Approval.aspx.cs" Inherits="Billing.Accountsbootstrap.SamplingCosting_Approval" %>
...
<head id="Head1" runat="server">
    ...
    <title>Sampling & Costing Approval Process </title>
                        ...
                        <div class="list-group">
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        <label>
                                            Approval Style No:</label>
                                        <asp:DropDownList ID="ddlapprovalStyles" runat="server" CssClass="chzn-select" Style="height: 30px"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator3" ControlToValidate="txtBuyerPrintStyle"
                                            ...
                                            Style="color: Red" />
                                        <asp:TextBox ID="txtBuyerPrintStyle" runat="server" Width="100%" Height="26px"></asp:TextBox>
                                    </div>
                                    <div class="form-group">
                                        <label>
                                            Description:</label>
                                        ...
                                        <asp:TextBox ID="txtDescription" runat="server" Width="100%" Height="26px"></asp:TextBox>
                                    </div>
                                    <table>
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <asp:CompareValidator ID="CompareValidator4" runat="server" ValidationGroup="val1"
                                                        ...
                                                        Operator="NotEqual" Type="String" ErrorMessage="Please Select Size."></asp:CompareValidator>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtFabricationCost" runat="server" Width="100%" Height="26px" AutoPostBack="true"
                                            OnTextChanged="txtFabricationCost_OnTextChanged"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtEmbroideryMachineCost" runat="server" Width="100%" Height="26px"
                                            AutoPostBack="true" OnTextChanged="txtEmbroideryMachineCost_OnTextChanged"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtEmbroideryHandCost" runat="server" Width="100%" Height="26px"
                                            AutoPostBack="true" OnTextChanged="txtEmbroideryHandCost_OnTextChanged"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtPieceProcessCost" runat="server" Width="100%" Height="26px" AutoPostBack="true"
                                            OnTextChanged="txtPieceProcessCost_OnTextChanged"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtFinishingandPackingCost" runat="server" Width="100%" Height="26px"
                                            AutoPostBack="true" OnTextChanged="txtFinishingandPackingCost_OnTextChanged"></asp:TextBox>
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtRejection" runat="server" Width="100%" Height="26px" AutoPostBack="true"
                                            OnTextChanged="txtRejection_OnTextChanged"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtExtraMargin" runat="server" Width="100%" Height="26px" AutoPostBack="true"
                                            OnTextChanged="txtExtraMargin_OnTextChanged"></asp:TextBox>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtTotalSmpCost" ReadOnly="true" runat="server" Width="100%" Height="30px"></asp:TextBox>
                                                </div>
                                                <div class="form-group">
                                                    <label>
                                                    ...
                                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator18" ControlToValidate="txtTotalPrdCost"
                                                        ValidationGroup="val1" Text="*" ErrorMessage="Please Check Total Cost in." Style="color: Red" />
                                                    <asp:TextBox ID="txtTotalPrdCost" ReadOnly="true" runat="server" Width="100%" Height="30px"></asp:TextBox>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Button ID="btnSave" runat="server" class="btn btn-primary" Text="Approve" ValidationGroup="val1"
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtRate" Height="30px" Width="100%" runat="server" CssClass="form-control"></asp:TextBox>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtSmpAvg" Height="30px" Width="100%" runat="server" CssClass="form-control"></asp:TextBox>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="txtPrdAvg" Height="30px" Width="100%" runat="server" CssClass="form-control"></asp:TextBox>
