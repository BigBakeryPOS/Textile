<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemProcessOrderGrid.aspx.cs"
    Inherits="Billing.Accountsbootstrap.ItemProcessOrderGrid" %>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="ToDate" DataField="ToDate" DataFormatString="{0:dd/MM/yyyy}" />
                                              ...
                                              <asp:BoundField HeaderText="Qty" DataField="Qty" DataFormatString="{0:f2}"  ItemStyle-HorizontalAlign="Right"/>
                                                <asp:BoundField HeaderText="RecQty" DataField="RecQty" DataFormatString="{0:f2}"  ItemStyle-HorizontalAlign="Right"/>
                                            ...
                                            <asp:TemplateField HeaderText="View" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("ItemPOId") %>'
                                                        CommandName="edit">
                                                    ...
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("ItemPOId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Print" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnPrint" runat="server" CommandArgument='<%#Eval("ItemPOId") %>'
                                                        CommandName="Print">
                                            ...
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("ItemPOId") %>'
