<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CuttingProcessEntryEmployee.aspx.cs" Inherits="Billing.Accountsbootstrap.CuttingProcessEntryEmployee" %>
...
<body>
    ...
    <form id="Form1" runat="server">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: #336699; color: White; border-color: #06090c">
                        ...
                        <asp:Label ID="lblName" Text="Process Entry" runat="server"></asp:Label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-4"></div>
            <div class="col-lg-4">
                <asp:GridView ID="GvSubProcess" runat="server" BackColor="White" Width="100%" EmptyDataText="No Records Found"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Process" HeaderStyle-Width="45px" ItemStyle-Width="45px">
                            <ItemTemplate>
                                <asp:Label ID="lblProcess" Height="30px" Width="100%" runat="server"></asp:Label>


                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Sub Process" Visible="true" HeaderStyle-Width="80px" ItemStyle-Width="80px">
                            <ItemTemplate>
                                <asp:DropDownList ID="drpSubPro" runat="server" CssClass="chzn-select" Style="height: 30px" Width="70%"></asp:DropDownList>
        ...
        <div class="panel-body" style="margin-top: 30px; height: 100%">
            ...
            <div class="col-lg-12">
                <div class="col-lg-9">
                    <asp:GridView ID="GVItem" AutoGenerateColumns="False" runat="server" OnRowCommand="GVItem_OnRowCommand"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Qty" HeaderStyle-Width="40px" ItemStyle-Font-Size="Large"
                                ItemStyle-Font-Bold="true">
                                <ItemTemplate>
                                    <asp:Label ID="lblQty" Height="30px" Width="40px" runat="server" Text='<%#Eval("Qty")  %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="View" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="1px"
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnView" runat="server" CommandArgument='<%#Eval("RowId") %>'
                                        CommandName="View">
                                        <asp:Image ID="imgView" runat="server" ImageUrl="~/images/pen-checkbox-128.png" />
                                    </asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    ...
                    <asp:Button ID="btnupdaterate" Visible="false" runat="server" Text="Update Rate" Width="100%" OnClick="btnUpdate_OnClick" />
            ...
            <div class="col-md-12">
                ...
                <div class="col-lg-12" style="font-weight: bold; padding-bottom: 18px;">
                    <h3 class="mb30">Employee Details</h3>
                </div>
                ...
                <div class="col-lg-1">
                    <div class="form-group">
                        <label>
                            Emp Name:</label>
                        <asp:DropDownList ID="drpEmployee" runat="server" CssClass="chzn-select" Style="height: 30px" Width="100px"></asp:DropDownList>
                ...
                <div class="col-lg-1">
                    <div class="form-group">
                        <label>
                            Style:</label>
                        <asp:DropDownList ID="drpStyle" runat="server" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="drpStyle_SelectedIndexChanged" Style="height: 30px" Width="100px"></asp:DropDownList>
                ...
                <div class="col-lg-1">
                    <div class="form-group">
                        <label>
                            Color:</label>
                        <asp:DropDownList ID="drpColor" runat="server" CssClass="chzn-select" Style="height: 30px" Width="100px"></asp:DropDownList>
                ...
                <div class="col-lg-1">
                    <div class="form-group">
                        <label>
                            Process:</label>
                        <asp:DropDownList ID="drpProcess" runat="server" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="drpProcess_OnSelectedIndex" Style="height: 30px" Width="100px"></asp:DropDownList>
                ...
                <div class="col-lg-1" runat="server" visible="false">
                    <div class="form-group">
                        <label>
                            Sub Process:</label>
                        <asp:DropDownList ID="drpSubProcess" runat="server" CssClass="chzn-select" AutoPostBack="true" OnSelectedIndexChanged="drpSubProcess_OnSelectedIndex" Style="height: 30px" Width="100px"></asp:DropDownList>
                ...
                <div class="col-lg-1">
                    <div class="form-group">
                        <label>
                            Rate:</label>
                        <asp:Label ID="lblRate1" Height="30px" Width="100%" runat="server"></asp:Label>
                 ...
                 <div class="col-lg-1">
                    <div class="form-group">
                        <label>
                            Receive Qty:</label>
                        <asp:Label ID="lblReceiveQty1" Height="30px" Width="100%" runat="server"></asp:Label>
                 ...
                 <div class="col-lg-1">
                    <div class="form-group">
                        <label>
                            Damage Qty:</label>
                        <asp:Label ID="lblDamageQty1" Height="30px" Width="100%" runat="server"></asp:Label>
                  ...
                  <div class="col-lg-1">
                    <div class="form-group">
                        <label>
                            Size:</label>
                        <asp:Label ID="lblSize1" Height="30px" Width="100%" runat="server"></asp:Label>

                    </div>
                </div>

                <div class="col-md-1" id="Div17" runat="server">
                    <br />
                    <asp:Button ID="btnAddTax" runat="server" class="btn blue" Text="ADD" ValidationGroup="Validation1"
                        OnClick="btnAddTax_OnClick" />
                </div>
            ...
            <div class="col-lg-12">
             <div class="col-lg-9">
            <asp:GridView ID="GVEmployee" runat="server" Width="100%" CssClass="myGridStyle1" OnRowDeleting="GVEmployee_RowDeleting" EmptyDataText="No Records Found"
                AutoGenerateColumns="false" Caption="Employee Wise">
                <HeaderStyle BackColor="White" />
                <EmptyDataRowStyle HorizontalAlign="Center" BackColor="White" ForeColor="Black" />
                <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast"
                    NextPageText="Next" PreviousPageText="Previous" />
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Employee Name  ">
                        <ItemTemplate>
                            <asp:Label ID="lblEmployeeName" Height="30px" Width="100%" runat="server"></asp:Label>
                            <asp:Label ID="lblEmployeeID" Height="30px" Width="100%" Visible="false" runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="Style">
                        <ItemTemplate>
                            <asp:Label ID="lblStyle" Height="30px" Width="100%" runat="server"></asp:Label>
                            <asp:Label ID="lblStyleID" Height="30px" Width="100%" Visible="false" runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="Color">
                        <ItemTemplate>
                            <asp:Label ID="lblColor" Height="30px" Width="100%" runat="server"></asp:Label>
                            <asp:Label ID="lblColorID" Height="30px" Width="100%" Visible="false" runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Process  ">
                        <ItemTemplate>
                            <asp:Label ID="lblProcess" Height="30px" Width="100%" runat="server"></asp:Label>
                            <asp:Label ID="lblProcessID" Height="30px" Width="100%" Visible="false" runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="Sub Process  " runat="server" Visible="false">
                        <ItemTemplate>
                            <asp:Label ID="lblSubProcess" Height="30px" Width="100%" runat="server"></asp:Label>
                            <asp:Label ID="lblSubProcessID" Height="30px" Width="100%" Visible="false" runat="server"></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Rate  ">
                        <ItemTemplate>
                            <asp:Label ID="lblRate" Height="30px" Width="100%" runat="server"></asp:Label>
                         
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Receive Qty  ">
                        <ItemTemplate>
                            <asp:Label ID="lblReceiveQty" Height="30px" Width="100%" runat="server"></asp:Label>
                         
                        </ItemTemplate>
                    </asp:TemplateField>
                      <asp:TemplateField HeaderText="Damage Qty  ">
                        <ItemTemplate>
                            <asp:Label ID="lblDamageQty" Height="30px" Width="100%" runat="server"></asp:Label>
                         
                        </ItemTemplate>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="Size">
                        <ItemTemplate>
                            <asp:Label ID="lblSize" Height="30px" Width="100%" runat="server"></asp:Label>
                         
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:LinkButton ID="btndelete" CssClass="btn red btn-sm" runat="server" CommandName="delete"> <i class="fa fa-trash-o"></i> Delete </asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:GridView ID="GVSizes" AutoGenerateColumns="False" GridLines="Both" runat="server" ShowFooter="true" OnRowDataBound="GVSize_rowdatabound"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Qty" HeaderStyle-Width="50px" ItemStyle-Font-Size="Large"
                                ItemStyle-Font-Bold="true">
                                <ItemTemplate>
                                    <asp:Label ID="lblQty" Height="30px" Width="50px" runat="server" Text='<%#Eval("Qty")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <asp:GridView ID="GVSizesView" AutoGenerateColumns="False" GridLines="Both" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Qty" HeaderStyle-Width="100px" ItemStyle-Font-Size="Large"
                                ItemStyle-Font-Bold="true">
                                <ItemTemplate>
                                    <asp:Label ID="lblQty" Height="30px" runat="server" Text='<%#Eval("Qty")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
