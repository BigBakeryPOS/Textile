                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-1">
                                    ...
                                    <div class="form-group">
                                        <label>
                                            Challan No :</label>
                                        <asp:TextBox ID="txtChallanNo" runat="server" CssClass="form-control center-block" AutoComplete="Off"  Width="110px"
                                            Enabled="true"></asp:TextBox>
                                        <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="txtChallanNo"
            ...
            <asp:GridView ID="GVItem" AutoGenerateColumns="False" GridLines="Both" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="BalQty" HeaderText="BalQty" HeaderStyle-HorizontalAlign="Right"
                        ItemStyle-HorizontalAlign="Right" DataFormatString="{0:f2}" />
                    <asp:BoundField DataField="PossibleBalQty" HeaderText="Possible BalQty (Shrink %)"
                        HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:f2}" />
