...
{
    public partial class CuttingProcessEntry : System.Web.UI.Page
    {
                           ...
                           // btnSave.Text = "Receive";
                            ...
                            if (dsCuttingProcessEntryItems.Tables[0].Rows.Count > 0)
                            {
                                ...
                                foreach (DataRow Dr in dsCuttingProcessEntryItems.Tables[0].Rows)
                                {
                                    ...
                                    drNew["ReturnQty"] = Dr["TotalReturned"];
                                    dstd.Tables[0].Rows.Add(drNew);
                                    dtddd = dstd.Tables[0];
                                }
                            ...
                            if (dsCuttingProcessEntrySizes.Tables[0].Rows.Count > 0)
                            {
                                ...
                                foreach (DataRow Dr in dsCuttingProcessEntrySizes.Tables[0].Rows)
                                {
                                    ...
                                    drNew1["ReturnQty"] = Dr["TotalReturned"];
                                    dstd1.Tables[0].Rows.Add(drNew1);
                                    dtddd1 = dstd1.Tables[0];
        ...
        protected void GVSize_rowdatabound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                TotRtnQty += Convert.ToInt32(txtReturnQty.Text);
            ...
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                e.Row.Cells[6].Text = TotRtnQty.ToString();
            }
        ...
        protected void Return_changed(object sender, EventArgs e)
        {
            TextBox ddl = (TextBox)sender;
            GridViewRow row = (GridViewRow)ddl.NamingContainer;
        ...
        public void Calculations()
        {
            for (int vLoop = 0; vLoop < GVSizes.Rows.Count; vLoop++)
            {
                ...
                TextBox txtReturnQty = (TextBox)GVSizes.Rows[vLoop].FindControl("txtReturnQty");
            ...
            GVSizes.FooterRow.Cells[6].Text = TotRtnQty.ToString();
        }
        ...
        protected void GVItem_OnRowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Modify")
            {
                ...
                if (e.CommandArgument.ToString() != "")
                {
                    ...
                    ReturnQty.Text = RowsGVSizeDetails[0]["ReturnQty"].ToString();
                    ...
                    for (int i = 0; i < RowsGVSizeQty.Length; i++)
                    {
                        ...
                        drNew1["ReturnQty"] = RowsGVSizeQty[i]["ReturnQty"].ToString();
                        dstd1.Tables[0].Rows.Add(drNew1);
                        dtddd1 = dstd1.Tables[0];
        ...
        protected void btnSubmitQty_OnClick(object sender, EventArgs e)
        {
            ...
            {
                double IssueQty = 0; double ReceiveQty = 0; double DamageQty = 0; double ReturnQty = 0;
                for (int vLoop = 0; vLoop < GVSizes.Rows.Count; vLoop++)
                {
                    Label lblSize = (Label)GVSizes.Rows[vLoop].FindControl("lblSize");
                    Label lblQty = (Label)GVSizes.Rows[vLoop].FindControl("lblQty");
                    ...
                    if (Convert.ToDouble(lblQty.Text) < (Convert.ToDouble(txtReceiveQty.Text) + Convert.ToDouble(txtDamageQty.Text) + Convert.ToDouble(txtReturnQty.Text)))
                    {
                        ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Please Check Qty in Size " + lblSize.Text + ".')", true);
                        txtReceiveQty.Focus();
                        return;
                    ...
                    ReturnQty += Convert.ToDouble(txtReturnQty.Text);
                }
                ...
                if (ViewState["CurrentTable2"] != null)
                {
                    ...
                    for (int vLoop = 0; vLoop < GVSizes.Rows.Count; vLoop++)
                    {
                        ...
                        drNew1["ReturnQty"] = txtReturnQty.Text;
                        dstd1.Tables[0].Rows.Add(drNew1);
                        dtddd1 = dstd1.Tables[0];
        ...
        protected void btnSave_OnClick(object sender, EventArgs e)
        {
            ...
            if (btnSave.Text == "Save")
            {
                ...
                int ProcessEntryId = objBs.InsertCuttingProcessEntry(txtEntryNo.Text, YearCode, Convert.ToInt32(dsEntryNo.Tables[0].Rows[0]["EntryNo"].ToString()), EntryDate, Convert.ToInt32(ddlExcNo.SelectedValue), Convert.ToInt32(ddlProcessFrom.SelectedValue), Convert.ToInt32(ddlProcess.SelectedValue), MaxRowId, txtRemarks.Text, Convert.ToInt32(ddlFinishingProcess.SelectedValue), Convert.ToInt32(ddlCompanyName.SelectedValue), Convert.ToInt32(ddlProcessLedger.SelectedValue), FromDate, ToDate);

                DataTable CurrentTable1 = (DataTable)ViewState["CurrentTable1"];
                int TransItemId = objBs.InsertTransCuttingProcessEntryItems(ProcessEntryId, Convert.ToInt32(ddlExcNo.SelectedValue), Convert.ToInt32(ddlProcessFrom.SelectedValue), CurrentTable1);

                DataTable CurrentTable2 = (DataTable)ViewState["CurrentTable2"];
                int TransSizeId = objBs.InsertTransCuttingProcessEntrySizes(ProcessEntryId, Convert.ToInt32(ddlExcNo.SelectedValue), Convert.ToInt32(ddlProcessFrom.SelectedValue), CurrentTable2);
            ...
            else
            {
                ...
                DataTable CurrentTable1 = (DataTable)ViewState["CurrentTable1"];
                int TransItemId = objBs.ReceiveTransCuttingProcessEntryItems_Return(Convert.ToInt32(ProcessEntryId), Convert.ToInt32(ddlExcNo.SelectedValue), Convert.ToInt32(ddlProcess.SelectedValue), CurrentTable1, txtChallanNo.Text, Convert.ToInt32(ddlProcessFrom.SelectedValue));

                DataTable CurrentTable2 = (DataTable)ViewState["CurrentTable2"];
                int TransSizeId = objBs.ReceiveTransCuttingProcessEntrySizes_Return(Convert.ToInt32(ProcessEntryId), Convert.ToInt32(ddlExcNo.SelectedValue), Convert.ToInt32(ddlProcess.SelectedValue), CurrentTable2, Convert.ToInt32(ddlCompanyName.SelectedValue), StockStatus, CurrentTable1, ddlExcNo.SelectedItem.Text, txtChallanNo.Text, Convert.ToInt32(ddlProcessFrom.SelectedValue));
            }
