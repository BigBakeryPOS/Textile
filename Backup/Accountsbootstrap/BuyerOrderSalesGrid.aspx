<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuyerOrderSalesGrid.aspx.cs"
    Inherits="Billing.Accountsbootstrap.BuyerOrderSalesGrid" %>
                                    ...
                                    <asp:GridView ID="GVItem" runat="server" CssClass="myGridStyle1" EmptyDataText="No records Found"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="View" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("BuyerOrderSalesId") %>'
                                                        CommandName="edit">
                                            ...
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("BuyerOrderSalesId") %>'
