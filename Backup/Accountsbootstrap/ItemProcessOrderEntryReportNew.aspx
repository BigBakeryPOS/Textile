<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemProcessOrderEntryReportNew.aspx.cs"
    Inherits="Billing.Accountsbootstrap.ItemProcessOrderEntryReportNew" %>
...
<head id="Head1" runat="server">
    ...
    <title>ItemProcessOrder Entry Report</title>
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-2">
                                <h1 class="page-header" style="text-align: center; color: #fe0002; font-size: 20px;
                                    font-weight: bold">
                                    ItemProcessOrder Entry Report</h1>
                            ...
                            <div class="col-lg-2">
                                <div class="form-group" id="ExcNo" runat="server" visible="true">
                                    <asp:TextBox ID="txtfabcontrast" runat="server" Width="100%" placeholder="Find OrderNo"
                                        AutoComplete="off" onkeyup="SearchEmployees(this,'#chkPONo');"></asp:TextBox>
                        ...
                        <div id="Excel" runat="server">
                            <asp:GridView ID="gvOrderReport" runat="server" CssClass="myGridStyle1" EmptyDataText="No records Found"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Process " DataField="Process" FooterStyle-HorizontalAlign="Right"
                                        Visible="false" />
                                    ...
                                    <asp:BoundField HeaderText="Amount " DataField="Amount" DataFormatString="{0:f2}"
                                        ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
                                    <asp:BoundField HeaderText="Iss.Qty " DataField="RecQty" DataFormatString="{0:f2}"
                                        ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
                                    <asp:BoundField HeaderText="Rec.Qty " DataField="ReceiveQty" DataFormatString="{0:f2}"
                                        ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
                                    <asp:BoundField HeaderText="ShrinkQty " DataField="ShrinkQty" DataFormatString="{0:f2}" Visible="false"
                                        ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
                                    <asp:BoundField HeaderText="Total " DataField="Total" DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Right"  Visible="false"
                                        FooterStyle-HorizontalAlign="Right" />
                                    <asp:BoundField HeaderText="Balance " DataField="Balance" DataFormatString="{0:f2}"  Visible="false"
                                        ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
                                </Columns>
