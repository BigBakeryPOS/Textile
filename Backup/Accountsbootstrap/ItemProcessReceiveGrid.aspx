<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemProcessReceiveGrid.aspx.cs"
    Inherits="Billing.Accountsbootstrap.ItemProcessReceiveGrid" %>
                                    ...
                                    <asp:GridView ID="GVItemProcessOrder" runat="server" CssClass="myGridStyle1" EmptyDataText="No records Found"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="View" ItemStyle-HorizontalAlign="Center" Visible="true">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("ItemPORecId") %>'
                                                        CommandName="edit">
                                                    ...
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("ItemPORecId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Export" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit1" runat="server" CommandArgument='<%#Eval("ItemPORecId") %>'
                                            ...
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("ItemPORecId") %>'
