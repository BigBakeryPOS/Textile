<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartyMaster.aspx.cs" Inherits="Billing.Accountsbootstrap.PartyMaster" %>
                                ...
                                <div class="col-lg-12">
                                    <div class="col-lg-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="drpfollowedby" runat="server"  CssClass="chzn-select" Width="100%" >
                                            </asp:DropDownList>
