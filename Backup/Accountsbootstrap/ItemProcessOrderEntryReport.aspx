<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemProcessOrderEntryReport.aspx.cs"
    Inherits="Billing.Accountsbootstrap.ItemProcessOrderEntryReport" %>
                            ...
                            <asp:GridView ID="gvOrderReport" runat="server" CssClass="myGridStyle1" EmptyDataText="No records Found"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Rec.Qty " DataField="ReceiveQty" DataFormatString="{0:f2}"
                                        ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
                                    <asp:BoundField HeaderText="ShrinkQty " DataField="ShrinkQty" DataFormatString="{0:f2}"
                                        ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
                                    <asp:BoundField HeaderText="Total " DataField="Total" DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Right"
                                        FooterStyle-HorizontalAlign="Right" />
                                    <asp:BoundField HeaderText="Balance " DataField="Balance" DataFormatString="{0:f2}"
                                        ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
                                </Columns>
