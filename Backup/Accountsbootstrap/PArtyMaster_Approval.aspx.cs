...
{
    public partial class PArtyMaster_Approval : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                #region
                DataSet dscustomer = objBs.Ledgername_Selected();
                if (dscustomer.Tables[0].Rows.Count > 0)
                {
                    drppartymaster.DataSource = dscustomer.Tables[0];
                    drppartymaster.DataTextField = "LedgerName";
                    drppartymaster.DataValueField = "LedgerId";
                    drppartymaster.DataBind();
                    drppartymaster.Items.Insert(0, "Select PartyMaster");
                }
        ...
        protected void PartyMAster_chnaged(object sender, EventArgs e)
        {
            string LedgerID = drppartymaster.SelectedValue;
        ...
        protected void Add_Click(object sender, EventArgs e)
        {
            ...
            if (btnadd.Text == "Approve")
            {
                ...
                int insertapproval = objBs.updateapprove(LedgerID, Status, ApprovedBy, EntryBy, Narration);
            ...
            ScriptManager.RegisterStartupScript(this, typeof(Page), "success", "<script>showpop1('" + text2 + "');window.location='PArtyMaster_Approval.aspx';</script>", false);

            //Response.Redirect("PArtyMaster_Approval.aspx");
        }
