<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseOrderReportNew.aspx.cs"
    Inherits="Billing.Accountsbootstrap.PurchaseOrderReportNew" %>
...
<head id="Head1" runat="server">
    ...
    <title>PurchaseOrder Report </title>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-2">
                                <h1 class="page-header" style="text-align: center; color: #fe0002; font-size: 20px;
                                    font-weight: bold">
                                    Purchase Order/GRN Report</h1>
                                <div class="form-group">
                                    <label>
                                        Type :</label>
                                    <asp:DropDownList ID="ddlChallan" runat="server" class="form-control" AutoPostBack="true"
                                        OnSelectedIndexChanged="ddlChallan_SelectedIndexChanged">
                                        <asp:ListItem Text="Purchase Order" Value="Order"></asp:ListItem>
                                        <asp:ListItem Text="Purchase GRN" Value="GRN"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-lg-2" id="BuyerCode" runat="server" visible="true">
                                ...
                                <div class="form-group">
                                    <label>
                                        Item Head:</label>
                                    <asp:DropDownList ID="ddlHead" runat="server" CssClass="chzn-select" Style="height: 30px"
                                        Width="100%">
                                    </asp:DropDownList>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-2">
                                ...
                                <div class="form-group" id="Div2" runat="server" visible="true">
                                    <asp:TextBox ID="TextBox1" runat="server" Width="100%" placeholder="Find EXCNo" onkeyup="SearchEmployees(this,'#chkEXCNo');"></asp:TextBox>
                                    <div style="overflow-y: scroll; height: 100px">
                                        <div class="panel panel-default" style="width: 350px">
                        ...
                        <div id="Excel" runat="server">
                            <asp:GridView ID="gvOrderReport" runat="server" CssClass="myGridStyle1" EmptyDataText="No Records Found"
                                OnRowDataBound="gvOrderReport_OnRowDataBound" Width="100%" AutoGenerateColumns="false"
                                ShowFooter="true" Caption="Purchase Order Report">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Shrink " DataField="Shrink" DataFormatString="{0:f2}"
                            ...
                            <asp:GridView ID="gvGRNReport" runat="server" CssClass="myGridStyle1" EmptyDataText="No Records Found"
                                ShowFooter="true" OnRowDataBound="gvGRNReport_OnRowDataBound" Width="100%" AutoGenerateColumns="false"
                                Caption="Purchase GRN Report">
                                <HeaderStyle BackColor="White" />
                                <EmptyDataRowStyle HorizontalAlign="Center" BackColor="White" ForeColor="Black" />
                                <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast"
                                    NextPageText="Next" PreviousPageText="Previous" />
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Item " DataField="Item" />
                                    <asp:BoundField HeaderText="Color " DataField="Color" />
                                    <asp:BoundField HeaderText="Qty " DataField="Qty" Visible="false" DataFormatString="{0:f2}"
                                        ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
                                    <asp:BoundField HeaderText="Shrink " DataField="Shrink" Visible="false" DataFormatString="{0:f2}"
                                        ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
                                    <asp:BoundField HeaderText="TotalQty " DataField="TotalQty" Visible="false" DataFormatString="{0:f2}"
                                        ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
                                    <asp:BoundField HeaderText="Rate " DataField="Rate" DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Right"
                                        FooterStyle-HorizontalAlign="Right" />
                                    <asp:BoundField HeaderText="RecQty " DataField="RecQty" DataFormatString="{0:f2}"
