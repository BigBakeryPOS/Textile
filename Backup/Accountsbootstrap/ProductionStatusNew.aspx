<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductionStatusNew.aspx.cs"
    Inherits="Billing.Accountsbootstrap.ProductionStatusNew" %>
                ...
                <div class="panel-body">
                    <div class="row">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlBuyerCode" runat="server" CssClass="chzn-select" Width="100%"
                                        AutoPostBack="true" OnSelectedIndexChanged="buyer_order">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-lg-2">
                        ...
                        <div id="Excel" runat="server">
                            <asp:GridView ID="gvCuttingQtyDetails" runat="server" EmptyDataText="No Records Found"  Visible="false"
                                OnRowDataBound="gvCuttingQtyDetails_OnRowDataBound" Caption="Production Status"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="QtyDate" HeaderText="QtyDate" Visible="true" />
                                </Columns>
                            </asp:GridView>
                            .

                               <asp:GridView ID="gvCuttingQtyDetailsSummary" runat="server" EmptyDataText="No Records Found" Visible="false"
                                OnRowDataBound="gvCuttingQtyDetailsSummary_OnRowDataBound" Caption="Production Status"
                                GridLines="Both" Width="100%" AutoGenerateColumns="false">
                                <HeaderStyle BackColor="#59d3b4" BorderStyle="Solid" BorderWidth="1px" BorderColor="Gray"
                                    Font-Names="arial" Font-Size="Smaller" />
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="LastDate" HeaderText="Last Date" Visible="false" />
                                    <asp:BoundField DataField="ShippingDate" HeaderText="Shipping Date" Visible="false" />
                                    <asp:BoundField DataField="Style" HeaderText="Style" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="OrderQty" HeaderText="OrderQty" ItemStyle-HorizontalAlign="Right"
                                        Visible="false" />
                                    <asp:BoundField DataField="IssQty" HeaderText="IssQty" ItemStyle-HorizontalAlign="Right" />
                                    ...
                                    <asp:BoundField DataField="RecBalQty" HeaderText="RecBalQty" ItemStyle-HorizontalAlign="Right" />
                                    <asp:BoundField DataField="IssBalQty" HeaderText="IssBalQty" ItemStyle-HorizontalAlign="Right" />
                                    <asp:BoundField DataField="QtyDate" HeaderText="QtyDate" Visible="false" />
                                </Columns>
                            </asp:GridView>
                        </div>
                    </div>
