<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartyType.aspx.cs" Inherits="Billing.Accountsbootstrap.PartyType" %>
                                ...
                                <td>
                                    <div id="Div2" runat="server" style="height: 520px; overflow: scroll;" align="center">
                                        <asp:GridView ID="gridview" runat="server" Width="100%" EmptyDataText="No Records Found"
                                            DataKeyNames="PartyTypeId" AutoGenerateColumns="false" CssClass="myGridStyle1"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="PartyType" SortExpression="PartyType" HeaderText="PartyType"
                                                    ItemStyle-Width="45%" />
                                                <asp:BoundField DataField="ManagementApproval" SortExpression="ManagementApproval"
                                                    HeaderText="PartyType" ItemStyle-Width="10%" />
                                                <asp:BoundField DataField="ProcessEntryApproval" SortExpression="ProcessEntryApproval"
                                                    HeaderText="ProcessEntryApproval" ItemStyle-Width="10%" />
                                                ...
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" HeaderText="Modify">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnedit" CommandArgument='<%#Eval("PartyTypeId") %>' CommandName="Select"
                                                            runat="server">
                                                            <asp:Image ID="imdedit" ImageUrl="~/images/pen-checkbox-128.png" runat="server" />
                                                        </asp:LinkButton>
                                                        <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("PartyTypeId") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%" HeaderText="Delete"
                                                    Visible="false">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btndel" CommandArgument='<%#Eval("PartyTypeId") %>' CommandName="Del"
                                                            runat="server">
        ...
        <div class="col-lg-4" style="margin-left: -14px">
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color: #336699; color: White;">
                    ...
                    <asp:Label ID="lblName" Text="Add PartyType" runat="server"></asp:Label>
                </div>
                <div class="panel-body">
                    <div class="list-group">
                        ...
                        <div class="form-group">
                            <asp:TextBox CssClass="form-control" ID="txtPartyTypeID" runat="server" Visible="false"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label>
                                Enter PartyType</label>
                            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="txtPartyType"
                                ValidationGroup="val2" Text="*" ErrorMessage="Please enter your PartyType." Style="color: Red" />
                            <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                                FilterType="LowercaseLetters, UppercaseLetters,Numbers,Custom" ValidChars=" -"
                                TargetControlID="txtPartyType" />
                            <asp:TextBox CssClass="form-control" ID="txtPartyType" runat="server" placeholder="To Add New PartyType"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label>
                                Check For Management Approval List</label><br />
                            <asp:CheckBox ID="chkmanagementApproval" runat="server" />
                        </div>
                        <div class="form-group">
                            <label>
                                Check For Process Entry Approval List</label><br />
                            <asp:CheckBox ID="chkProcessEntryApproval" runat="server" />
                        </div>
                        <div class="form-group">
                            <label>
                                Check Item Head</label>
                            <asp:CheckBoxList ID="chkitemlist" runat="server" CssClass="chkChoice" RepeatColumns="1">
                            </asp:CheckBoxList>
                        </div>
                        <div class="form-group">
                            <label>
