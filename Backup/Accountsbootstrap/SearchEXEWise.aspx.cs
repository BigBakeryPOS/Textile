...
{
    public partial class SearchEXEWise : System.Web.UI.Page
    {
        ...
        {
            DataSet dsEXC = objBs.Get_BuyerOrder_EXC(drpyear.SelectedValue);
            if (dsEXC.Tables[0].Rows.Count > 0)
            {
                ddlEXCNo.DataSource = dsEXC.Tables[0];
        ...
        protected void btnSearch_OnClick(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Please Select EXCNo.');", true);
                ddlEXCNo.Focus();
                return;
            }

            //BuyerOrder
            DataSet dsEXCBuyerOrder = objBs.SearchEXCWise_BuyerOrder(ddlEXCNo.SelectedValue);
            ...
            //RequirementSheet
            DataSet dsRequirementSheet = objBs.SearchEXCWise_RequirementSheet(ddlEXCNo.SelectedValue);
            ...
            DataSet dstyleno = objBs.getstyledescr(ddlEXCNo.SelectedValue);
            if (dstyleno.Tables[0].Rows.Count > 0)
            {
                DataSet getcolorchnagedetails = objBs.getcolorchnagedescription_Update(ddlEXCNo.SelectedValue);
            ...
            //ExcOpeningStock
            DataSet dsExcOpeningStock = objBs.SearchEXCWise_OpeningStock(ddlEXCNo.SelectedItem.Text);
            ...
            //ItemProcessOrder
            DataSet dsItemProcessOrder = objBs.SearchEXCWise_ItemProcessOrder(ddlEXCNo.SelectedValue);
            ...
            //ItemProcessIssue
            DataSet dsItemProcessIssue = objBs.SearchEXCWise_ItemProcessIssue(ddlEXCNo.SelectedValue);
            ...
            //ItemProcessReceive
            DataSet dsItemProcessReceive = objBs.SearchEXCWise_ItemProcessReceive(ddlEXCNo.SelectedValue);
            ...
            //PreCutting
            DataSet dsPreCutting = objBs.SearchEXCWise_PreCutting(ddlEXCNo.SelectedValue);
            ...
            //MasterCutting
            DataSet dsMasterCutting = objBs.SearchEXCWise_MasterCutting(ddlEXCNo.SelectedValue);
            if (dsMasterCutting.Tables[0].Rows.Count > 0)
            {
                ...
                DataSet dsBuyerOrderCuttingrItems = objBs.GetTransBuyerOrderCuttingItems_Master(Convert.ToInt32(dsMasterCutting.Tables[0].Rows[0]["BuyerOrderMasterCuttingId"]));
            ...
            //MaterialIssue
            DataSet dsMaterialIssue = objBs.SearchEXCWise_MaterialIssue(ddlEXCNo.SelectedItem.Text);
            ...
            //Process
            DataSet dsProcess = objBs.SearchEXCWise_Process(ddlEXCNo.SelectedValue);
