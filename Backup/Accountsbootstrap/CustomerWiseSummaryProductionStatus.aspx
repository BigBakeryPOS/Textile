<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerWiseSummaryProductionStatus.aspx.cs" Inherits="Billing.Accountsbootstrap.CustomerWiseSummaryProductionStatus" %>
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-3">
                                <h1 class="page-header" style="text-align: center; color: #fe0002; font-size: 20px;
                                    font-weight: bold">
                                    Date Wise Summary Production Status
                                </h1>
                            </div>
                            <div class="col-lg-2">
